...
// Initialize the Inter font with comprehensive weight range
const inter = Inter({ 
  subsets: ['latin'],
  display: 'swap',
  variable: '--font-inter',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className={inter.variable}>
      ...
      <body className="min-h-screen antialiased bg-background text-foreground font-sans selection:bg-blue-100 selection:text-blue-900 dark:selection:bg-blue-900 dark:selection:text-blue-100">
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
          enableSystem
